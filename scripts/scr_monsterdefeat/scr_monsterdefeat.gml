...
if (killed == 0)
{
    ...
    ddd.image_speed = 0
    ddd.image_index = 1
    if (object_index == obj_lesserdoge && surface_exists(surface))
    {
        ddd.x = 0
        ddd.y = 0
        ddd.image_xscale = 1
        ddd.image_yscale = 1
        ddd.sprite_index = sprite_create_from_surface(surface, 0, 0, room_width, room_height, false, false, 0, 0)
        scr_add_temp_sprite(ddd.sprite_index)
    }
    global.flag[10] = 1
    global.flag[23] += 1
}
