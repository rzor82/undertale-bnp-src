switch argument0
{
    case 0:
        break
    case 1:
        global.msg[0] = "\\XLa^1, la.^3 &Time to wake&up and\\R smell\\X &the^4 pain./"
        global.msg[1] = "* Though^2.^4.^6.^8.&It's still a&little shaky./"
        global.msg[2] = "fhuehfuehfuehfuheufhe/%"
        global.msg[3] = "%%%"
        break
    case 2:
        global.msg[0] = "* TestFroggit and its cohorts&  draw near!"
        global.msg[1] = "%%%"
        break
    case 3:
        global.msg[0] = ""
        ...
        for (var i = 0; i < 3; i++)
        {
            if global.monster[i]
            {
                with (global.monsterinstance[i])
                {
                    scr_mercystandard()
                    col = (shiny ? "V" : "W")
                    if (mercy < 0 && global.flag[22] != 1)
                    {
                        if (object_index == obj_finalknight && asleep)
                            col = "L"
                        else if (global.flag[22] == 0)
                            col = "Y"
                        else if (global.flag[22] == 2)
                            col = "p"
                        if shiny
                            col = (((("S" + col) + "V[") + string(string_width((scr_gettext("battle_name_header") + global.monstername[i])))) + "]")
                    }
                    global.msg[0] += ((("\\" + col) + scr_gettext("battle_name_header")) + global.monstername[i])
                    if (object_index == obj_mirrorb && shielded)
                        global.msg[0] += " (Shielded)"
                    if (mercy < 0 && global.flag[22] != 1)
                    {
                        global.msg[0] += " \\z"
                        if (object_index == obj_finalknight && asleep)
            ...
            if global.monster[i]
            {
                with (global.monsterinstance[i])
                {
                    ...
                    if (mercy < 0 && global.flag[22] != 1)
                    {
                        ...
                        if shiny
                        {
                            mercycol = (((("S" + mercycol) + "V[") + string(string_width(scr_gettext("battle_mercy_spare")))) + "]")
                            i = 3
                        }
                    }
                }
    ...
    case 15:
        ...
        if (room == room_ruins_sewer4)
        {
            global.msg[0] = "* (The uncertainty of&  where the ladder before&  you leads to...)/"
        ...
        if (room == room_tundra1)
        {
            ...
            if (scr_murderlv() >= 2)
                global.msg[0] = "* The cold air makes you feel&  alive./%%"
        }
        if (room == room_tundra3)
        {
            ...
            if (global.flag[6] == 1)
            {
                global.msg[0] = "* (Knowing the lamp will get&  the love and care it&  so deserves...)/"
        ...
        {
            global.msg[0] = "* (Walking so close to&  to the lava's edge...^1)&* (Fills you with determination.)/%%"
            if (scr_murderlv() >= 13)
                global.msg[0] = "* The heat rises from the&  lava^1, warming your&  skin./%%"
        }
        if (room == room_fire_core1)
            global.msg[0] = "* (The high-tech walls of the&  CORE loom above^1, filling you&  with determination.)/%%"
        if (room == room_water19)
            global.msg[0] = "* Suddenly feeling unprepared./%%"
        if (room == room_water_statue)
        {
            global.msg[0] = "* (The calm trickle of&  waterfalls ahead...)/"
            if (global.flag[86] == 1)
                global.msg[0] = "* (The music box eminates a&  calm, soothing melody...^1)/"
            global.msg[1] = "* (...It fills you&  with determination.^1)/%%"
            if (scr_murderlv() >= 8)
                global.msg[0] = "* Feels like visiting&  an old friend./%%"
        }
        if (room == room_water_prebhouse)
        {
            global.msg[0] = "* (Taking a breath after&  another close encounter...)/"
            global.msg[1] = scr_gettext("SCR_TEXT_152")
            if (scr_murderlv() >= 12)
                global.msg[0] = "* .../"
        }
        ...
        if (room == room_water_friendlyhub)
        {
            ...
            if (global.flag[94] > 0)
            {
                global.msg[0] = "* (The ghostly ambience spooks&  you to your core...)/"
    ...
    case 23:
        ...
        instance_create(0, 0, obj_quicheguilt)
        break
    case 30:
    ...
    case 220:
        ...
        global.msg[9] = "* Oh^1!&* There is one last&  thing you should know./"
        global.msg[10] = "\\E2* There may be future&  hallways as long as&  this one was.../"
        global.msg[11] = "\\E0\\W* ... simply press \\Y[X]\\W^1,&  you will be speeding&  off in no time!/"
        global.msg[12] = "\\E1* Please^1, be cautious and&  do not trip^1, my child./%%"
        global.msg[13] = scr_gettext("SCR_TEXT_455")
        break
    case 221:
    ...
    case 232:
        ...
        if (global.flag[85] == 0)
        {
            ...
            if (global.flag[60] >= 5)
            {
                global.msg[0] = scr_gettext("SCR_TEXT_712")
                global.msg[1] = scr_gettext("SCR_TEXT_713")
                global.msg[2] = scr_gettext("SCR_TEXT_714")
            }
        }
        if (global.flag[85] == 1)
        {
            ...
            if (global.flag[60] >= 5)
            {
                global.msg[0] = scr_gettext("SCR_TEXT_729")
                global.msg[1] = scr_gettext("SCR_TEXT_730")
                global.msg[2] = scr_gettext("SCR_TEXT_731")
            }
        }
        if (itemcount > 2)
        {
    ...
    case 264:
        if (global.flag[112] == 0)
        {
            ...
            global.msg[1] = scr_gettext("SCR_TEXT_1343")
            global.msg[2] = scr_gettext("SCR_TEXT_1344")
            global.msg[3] = scr_gettext("SCR_TEXT_1345")
        }
        else
    ...
    case 266:
        ...
        {
            global.msg[0] = "* (You dug around in&  the trash can.^1)&* (Well^1, let's see here...)/"
            global.msg[1] = scr_gettext("SCR_TEXT_1378")
            global.msg[2] = scr_gettext("SCR_TEXT_1379")
            global.msg[3] = scr_gettext("SCR_TEXT_1380")
        }
        else
    ...
    case 580:
        if (global.flag[84] == 4)
        {
            ...
            if (global.flag[7] == 1)
            {
                global.msg[0] = "* The king asked if I&  wanted to go to the&  surface with everyone else./"
                global.msg[1] = "* I told him I didn't want to^1!&* Just to be moved into&  the next room./"
                global.msg[2] = "* So..^1.&* That's what's happening^1!&* I'm estatic^1, that's for sure./%%"
            }
        }
        if (global.flag[84] == 5)
        {
            ...
            {
                global.msg[0] = "* The king asked if I&  wanted to go to the&  surface with everyone else./"
                global.msg[1] = "* I didn't respond to him^1.&* I don't want to think about&  anything outside this room again./%%"
            }
        }
        if (global.flag[84] < 2)
        {
        ...
        if (global.flag[84] == 2)
        {
            ...
            if (global.flag[7] == 1)
            {
                global.msg[0] = "* You left me hanging^1,&  but that's okay!/"
                global.msg[1] = "* The king asked if I&  wanted to go to the&  surface with everyone else./"
                global.msg[2] = "* I told him I didn't want to^1!&* Just to be moved into&  the next room./"
                global.msg[3] = "* So..^1.&* That's what's happening^1!&* I'm estatic^1, that's for sure./%%"
            }
        }
        if (global.flag[84] == 3)
        {
    ...
    case 587:
        if (global.flag[394] == 1)
            global.msg[0] = "* (The fridge is empty.)/%%"
        else
        {
    ...
    case 595:
        if (global.flag[394] == 1)
            global.msg[0] = "* (Nothing's here!!!^1)&* (Must mean you've already&  picked this one up.)/%%"
        else
        {
            global.msg[0] = "* (Inside is some sort of&  spectral fruit.)/"
            global.msg[1] = "* (Will you take it?)& &         Yes         No \\C"
            global.msg[2] = " "
        }
        break
    case 596:
        ...
        if (global.choice == 0)
        {
            ...
            {
                global.msg[0] = "* (You got the Ghost Fruit.)/%%"
                global.flag[394] = 1
            }
        }
        if (global.choice == 1)
    ...
    case 620:
        ...
        break
    case 621:
        global.msg[1] = scr_gettext("SCR_TEXT_3073")
        global.msg[2] = scr_gettext("SCR_TEXT_3074")
        global.msg[3] = scr_gettext("SCR_TEXT_3075")
        global.msg[4] = scr_gettext("SCR_TEXT_3076")
        global.msg[5] = scr_gettext("SCR_TEXT_3077")
        global.msg[6] = scr_gettext("SCR_TEXT_3078")
        global.msg[7] = scr_gettext("SCR_TEXT_3079")
        global.msg[8] = scr_gettext("SCR_TEXT_3080")
        global.msg[9] = scr_gettext("SCR_TEXT_3081")
        global.msg[10] = scr_gettext("SCR_TEXT_3082")
        global.msg[11] = scr_gettext("SCR_TEXT_3083")
        global.msg[12] = scr_gettext("SCR_TEXT_3084")
        global.msg[13] = scr_gettext("SCR_TEXT_3085")
        global.msg[14] = scr_gettext("SCR_TEXT_3086")
        break
    case 623:
    ...
    case 828:
        if (global.choice == 0)
        {
            ...
            global.msg[1] = "\\TA%"
            global.msg[2] = scr_gettext("SCR_TEXT_5221")
            global.msg[3] = scr_gettext("SCR_TEXT_5222")
            global.msg[4] = scr_gettext("SCR_TEXT_5223")
            global.msg[5] = scr_gettext("SCR_TEXT_5224")
            global.msg[6] = scr_gettext("SCR_TEXT_5225")
            global.msg[7] = scr_gettext("SCR_TEXT_5226")
            global.msg[8] = scr_gettext("SCR_TEXT_5227")
            global.msg[9] = scr_gettext("SCR_TEXT_5228")
            global.msg[10] = scr_gettext("SCR_TEXT_5229")
            global.msg[11] = scr_gettext("SCR_TEXT_5230")
            global.msg[12] = scr_gettext("SCR_TEXT_5231")
            global.msg[13] = scr_gettext("SCR_TEXT_5232")
            global.msg[14] = scr_gettext("SCR_TEXT_5233")
            global.msg[15] = scr_gettext("SCR_TEXT_5234")
            global.msg[16] = scr_gettext("SCR_TEXT_5235")
            global.msg[17] = "\\T0%"
            global.msg[18] = scr_gettext("SCR_TEXT_5236")
        }
        if (global.choice == 1)
    ...
    case 854:
        ...
        {
            ossafe_ini_open("undertale.ini")
            fight = ini_read_real("reset", "D", 0)
            if (global.debug == true || fight == 0)
            {
                ini_write_real("reset", "D", 1)
                global.battlegroup = 999
                global.msg[0] = "/%%"
    ...
    case 965:
        ...
        if (global.tempvalue[14] == 1)
        {
            ...
            with (obj_mewmew_npc)
            {
                sprite_index = spr_npc_mewmew_mad
                con = 1
            }
        }
        break
    case 966:
        ...
        break
    case 1001:
        global.msg[0] = "   * Question      * Dud &   * Talk          * Thought&   * Fact"
        global.choices[0] = 1
        global.choices[1] = 1
        global.choices[2] = 1
        global.choices[3] = 1
    ...
    case 1069:
        ...
        {
            global.msg[0] += "* Forgive&   * Reflect      "
            if (obj_mirrorb.actcon >= 4)
            {
                if (global.flag[22] == 0)
                    global.msg[0] += "\\Y "
                else if (global.flag[22] == 2)
    ...
    case 1077:
        ...
        break
    case 1078:
        global.msg[0] = "   * Check         * Lecture&   * Praise        * Pat"
        global.choices[0] = 1
        global.choices[1] = 1
        global.choices[2] = 0
        global.choices[3] = 1
        ...
        break
    case 1079:
        global.msg[0] = "   * Check         * Motivate&   * Roll          * Comfort"
        global.choices[0] = 1
        global.choices[1] = 1
        global.choices[2] = 0
        global.choices[3] = 1
    ...
    case 3007:
        ...
        break
    case 3008:
        global.msg[0] = "* (It's a toilet.^1)&* (It doesn't look like it's&  been used in a long time.)/"
        global.msg[1] = "* (Nobody is around to stop you.^1)&* (Flush the toilet?^1)&         Flush       Do Not \\C"
        global.msg[2] = scr_gettext("SCR_TEXT_817")
        break
    case 3009:
        if (global.choice == 0)
        {
            snd_play(snd_toilet)
            global.msg[0] = "* (You flush the toilet.^1)/%%"
        }
        if (global.choice == 1)
            global.msg[0] = "* (You decide that it's&  not worth the risk.)/%%"
        break
    case 3010:
        if (global.flag[242] == 0)
        {
            global.msg[0] = "* (Someone left behind a tub&  of perfectly yappy&  Puppydough Icecream.)/"
    ...
    case 3011:
        if (global.choice == 0)
        {
            if (doak == 0)
            {
                noroom = -1
                doak = 1
                script_execute(scr_itemget, 18)
            }
            if (noroom == 0)
            {
                global.msg[0] = "* (You adopted the&  Puppydough Icecream.)/%%"
                global.flag[242] = 1
            }
            if (noroom == 1)
                global.msg[0] = "* (You're carrying too much.)/%%"
        ...
        if (global.choice == 1)
            global.msg[0] = "* (You decide it's best to&  wait for its owner&  to reclaim it.)/%%"
        break
    case 3012:
        global.msg[0] = "* Hey^1, I haven't seen&  you around here./"
        global.msg[1] = "* Where did you come from?& &         Yes         No      \\C"
        global.msg[2] = scr_gettext("SCR_TEXT_817")
        break
    case 3013:
        if (global.choice == 0)
            global.msg[0] = "* Yes^1?&* Yes what^1?&* Is that what it's called?/%%"
        if (global.choice == 1)
            global.msg[0] = "* Oh^1, alright then^1.&* I guess that was&  a bit weird to ask.../%%"
        break
    case 3014:
        global.msg[0] = "* Hm^1? Oh^1, hello there!&* It's rare to see a new&  face around Waterfall./"
        global.msg[1] = "* Wait a minute..^1.&* You're a human aren't you?&         Yes         No      \\C"
        global.msg[2] = scr_gettext("SCR_TEXT_817")
        break
    case 3015:
        if (global.choice == 0)
            global.msg[0] = "* Wow^1!&* It's been a while since&  I've seen one around here./%%"
        if (global.choice == 1)
            global.msg[0] = "* I see^1.&* I guess my memory of what&  they look like is foggy.../%%"
        break
    case 3016:
        global.facechoice = "A"
        ...
        global.msg[0] = "* Yo^1, dude^1.&\\E5* I think this way&  is a dead end.../"
        global.msg[1] = "\\E0* Come on^1, let's&  find another way./"
        global.msg[2] = "\\F0&&         Sure        Proceed.\\C/"
        global.msg[3] = scr_gettext("SCR_TEXT_817")
        break
    case 3017:
        global.facechoice = "A"
        global.faceemotion = 0
        ...
        if (global.choice == 0)
        {
            global.msg[0] = "\\FA\\E3* Actually..^1.&* I think I could&  probably just.../%%"
            if instance_exists(obj_monsterkidtrigger6)
                obj_monsterkidtrigger6.con = 101
        }
        if (global.choice == 1)
            global.msg[0] = "%%"
        break
    case 3018:
        ...
        global.faceemotion = 0
        global.typer = 5
        global.msg[0] = "\\E9* What^1? \"Proceed?^1\"&* What do you mean?/"
        global.msg[1] = "\\F0&         I'm just&         kidding     Proceed.\\C"
        global.msg[2] = scr_gettext("SCR_TEXT_817")
        break
    case 3019:
        global.facechoice = "A"
        ...
        if (global.choice == 0)
        {
            global.msg[0] = "\\E6* H-haha..^1.&* I was scared&  for nothing./"
            global.msg[1] = "\\E0* Give me a sec^1,&  I can probably&  just.../%%"
            if instance_exists(obj_monsterkidtrigger6)
                obj_monsterkidtrigger6.con = 101
        }
        if (global.choice == 1)
        {
            global.msg[0] = "\\E6* There's no..^1.&* There's no way to&  get up there./"
            global.msg[1] = "* Can't we..^1.&* Try something else...?/"
            global.msg[2] = "\\F0&         Let's do&         that        Proceed.\\C"
            global.msg[3] = scr_gettext("SCR_TEXT_817")
        }
        break
    case 3020:
        ...
        if (global.choice == 0)
        {
            global.msg[0] = "\\E6* Th-thank you^1, dude^1.&* You had me&  scared there.../"
            global.msg[1] = "* I think I&  thought of&  something.../%%"
            if instance_exists(obj_monsterkidtrigger6)
                obj_monsterkidtrigger6.con = 101
        }
        if (global.choice == 1)
        {
            global.msg[0] = "\\E4* Alright^1, alright^1!&* Let me.../"
            global.msg[1] = "* I..^1.&* I think I've got it^1.&* I'll.../%%"
            if instance_exists(obj_monsterkidtrigger6)
                obj_monsterkidtrigger6.con = 103
        }
        break
    case 3021:
        global.msg[0] = "* (It's a shiny^1, red button.^1)&* (You can barely control&  the urge to...)/"
        global.msg[1] = "* (Push the button?)& &         Push It     Do Not \\C"
        global.msg[2] = scr_gettext("SCR_TEXT_817")
        break
    case 3022:
        if (global.choice == 0)
        {
            global.flag[428] = 1
            global.msg[0] = "* (You pushed the button.^1)&* (You hear the noise of a&  conveyor belt slowing down.)/%%"
        }
        if (global.choice == 1)
        {
            if (global.msg[45] != 4)
            {
                global.msg[0] = "* (You remember Toriel warning&  you about pushing&  unmarked buttons...)/"
                global.msg[1] = "* (You decided not to.)/%%"
            }
            else
                global.msg[0] = "* (You decide not to press the button.)/%%"
        }
        break
    case 3023:
        global.msg[0] = "* (It's a Croquet Roll.)&* (It appears to be a&  limited time offer.)/"
        global.msg[1] = "* (Take it?)& &         Take It      Do Not \\C"
        global.msg[2] = scr_gettext("SCR_TEXT_817")
        break
    case 3024:
        if (global.choice == 0)
        {
            if (doak == 0)
            {
                noroom = -1
                doak = 1
                script_execute(scr_itemget, 2)
            }
            if (noroom == 0)
            {
                global.flag[231] = 1
                global.msg[0] = "* (You took the Croquet Roll.)&* (You suddenly feel sporty.)/%%"
            }
            if (noroom == 1)
                global.msg[0] = "* (You're carrying too much.)/%%"
        }
        if (global.choice == 1)
            global.msg[0] = "* (You don't like to&  play with your food.^1)&* (You decided not to take it.)/%%"
        break
    case 3025:
        global.msg[0] = "* (A field of Stoic Onions&  is spread out before you.)/"
        global.msg[1] = "* (Take one?)& &         Take It      Do Not \\C"
        global.msg[2] = scr_gettext("SCR_TEXT_817")
        if (global.flag[232] > 3)
            global.msg[1] = "* (You're not worthy of&  handling any more&  Stoic Onions...)/%%"
        break
    case 3026:
        if (global.choice == 0)
        {
            if (doak == 0)
            {
                noroom = -1
                doak = 1
                script_execute(scr_itemget, 8)
            }
            if (noroom == 0)
            {
                if (global.flag[232] == 0)
                    global.msg[0] = "* (You took a Stoic Onion.)&* (You can still bear&  3 more Stoic Onions.)/%%"
                if (global.flag[232] == 1)
                    global.msg[0] = "* (You took a Stoic Onion.)&* (You can still bear&  2 more Stoic Onions.)/%%"
                if (global.flag[232] == 2)
                    global.msg[0] = "* (You took a Stoic Onion.)&* (You can still bear&  1 more Stoic Onion.)/%%"
                if (global.flag[232] == 3)
                    global.msg[0] = "* (You took a Stoic Onion.)&* (You cannot bear&  any more Stoic Onions.)/%%"
                if (global.flag[232] > 3)
                    global.msg[0] = "* (You're not worthy of&  handling any more&  Stoic Onions...)/%%"
                global.flag[232] += 1
            }
            if (noroom == 1)
                global.msg[0] = "* (You're carrying too much.)/%%"
        ...
        if (global.choice == 1)
            global.msg[0] = "* (You would rather observe&  beauty from afar.^1)&* (You decided not to take it.)/%%"
        break
    case 9999:
        i = 0
