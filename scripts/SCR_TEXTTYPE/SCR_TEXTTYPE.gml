...
if (global.typer == 1)
    ...
    SCR_TEXTSETUP(fnt_comicsans, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 310), 0, 1, snd_txtsans, 8, 18)
else if (global.typer == 18 || global.typer == 19)
{
    global.typer = 18
    ...
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 310), 0, 1.5, snd_tem, 8, 18)
else if (global.typer == 25)
{
    ...
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 290), 0, 1.5, snd_tem, 8, 18)
    ...
    SCR_TEXTSETUP(fnt_wingdings, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 290), 0, 3, snd_wngdng1, 16, 18)
...
else if (global.typer == 121)
    SCR_TEXTSETUP(fnt_main, c_white, (x + 20), (y + 20), (x + 99999), 0, 3, snd_nosound, 16, 32)
else if (global.typer == 122)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (view_xview[view_current] + 290), 0, 1, SND_TXT1, 8, 18)
else if (global.typer == 223)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 290), 0, 6, snd_txtund_armor, 8, 18)
...
else if (global.typer == 667)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 290), 0, 1, snd_txtund_armor, 8, 18)
else if (global.typer == 123)
    SCR_TEXTSETUP(fnt_plain, c_black, x, y, (x + 190), 0, 2, SND_TXT1, 9, 20)
else if (global.typer == 124)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 290), 0, 3, snd_txtrx1, 8, 18)
else if (global.typer == 125)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 290), 0, 1, snd_txtber, 8, 18)
else if (global.typer == 126)
    SCR_TEXTSETUP(fnt_maintext, c_white, x, (y + 20), (__view_get(0, view_current) + 290), 41, 1, snd_txtspider, 9, 20)
else if (global.typer == 127)
    SCR_TEXTSETUP(fnt_maintext, c_white, x, (y + 20), (__view_get(0, view_current) + 290), 41, 1, SND_TXT1, 9, 20)
else if (global.typer == 128)
    SCR_TEXTSETUP(fnt_plain, c_black, (x + 10), y, (x + 190), 41, 1, snd_txtspider, 9, 20)
else if (global.typer == 129)
    SCR_TEXTSETUP(fnt_plain, c_black, (x + 10), y, (x + 190), 41, 1, snd_txtdum, 9, 20)
else if (global.typer == 130)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 290), 0, 1, snd_txtdum, 9, 20)
else if (global.typer == 131)
    SCR_TEXTSETUP(fnt_plain, c_black, (x + 20), (y + 16), 999, 0, 3, snd_mtt1, 8, 18)
else if (global.typer == 132)
    SCR_TEXTSETUP(fnt_plain, c_black, (x + 20), (y + 10), 999, 1.5, 4, snd_mtt1, 8, 18)
else if (global.typer == 133)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 310), 0, 1, snd_txt_bpants, 8, 18)
else if (global.typer == 134)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 310), 0, 1, snd_txt_bpants_angry, 8, 18)
else if (global.typer == 135)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 310), 0, 1, snd_txt_bpants_weird, 8, 18)
else if (global.typer == 138)
    SCR_TEXTSETUP(fnt_tinymain, c_white, (x + 20), (y + 25), (__view_get(0, view_current) + 290), 0, 1, snd_txtal, 8, 18)
else if (global.typer == 145)
    SCR_TEXTSETUP(fnt_plain, c_black, (x + 10), y, (x + 190), 41, 3, snd_txt_mewem, 9, 20)
else if (global.typer == 146)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 290), 0, 3, snd_txt_mewem, 9, 20)
else if (global.typer == 147)
    SCR_TEXTSETUP(fnt_plain, c_white, x, y, (x + 190), 43, 3, snd_txt_mewem, 9, 20)
else if (global.typer == 148)
    SCR_TEXTSETUP(fnt_tinymain, c_white, (x + 20), (y + 25), (__view_get(0, view_current) + 290), 0, 1, SND_TXT1, 8, 18)
else if (global.typer == 223)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 290), 0, 6, snd_txtund_armor, 8, 18)
else if (global.typer == 224)
{
    SCR_TEXTSETUP(fnt_comicsans, c_white, x, (y - 40), 9999, 0, 2, snd_txtsans, 20, 36)
    htextscale = 2
    vtextscale = 2
}
else if (global.typer == 225)
    SCR_TEXTSETUP(fnt_small, c_black, x, y, (__view_get(0, view_current) + 290), 0, 1, SND_TXT1, 6, 10)
else if (global.typer == 666)
    SCR_TEXTSETUP(fnt_wingdings, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 290), 1, 4, snd_wngdng1, 16, 18)
else if (global.typer == 667)
    SCR_TEXTSETUP(fnt_maintext, c_white, (x + 20), (y + 20), (__view_get(0, view_current) + 290), 0, 1, snd_txtund_armor, 8, 18)
else
    show_error(("Invalid typer: " + string(global.typer)), 1)
if (global.language == "ja")
{
    if (myfont == fnt_main)
    {
