...
if (global.currentroom == room_ruins19)
    dogcheck = 1
if (global.currentroom == room_ruins18)
    dogcheck = 1
...
if (global.currentroom == room_water3)
    dogcheck = 1
if (global.currentroom == room_water_tutu)
    dogcheck = 1
...
if (global.currentroom == room_water_statue)
    dogcheck = 1
if (global.currentroom == room_fire_machinepit)
    dogcheck = 1
...
if (global.currentroom == room_fire_dock)
    dogcheck = 1
if (global.currentroom == room_water_bhouse_exit)
    dogcheck = 1
if (global.currentroom == room_fire3)
    dogcheck = 1
if (global.currentroom == room_fire_hotelrestaurant)
    dogcheck = 1
...
if (global.currentroom == room_fire10)
    dogcheck = 1
if (global.currentroom == room_water_postbhouse)
    dogcheck = 1
...
if (global.currentroom == room_fire_newsreport)
    dogcheck = 1
if (global.currentroom == room_fire_lavalake)
    dogcheck = 1
...
if (global.currentroom == room_water_temvillage)
    dogcheck = 1
if (global.currentroom == room_fire_opera)
    dogcheck = 1
if (global.currentroom == room_fire_multitile)
    dogcheck = 1
if (global.currentroom == room_water_bhouse_splitpath)
    dogcheck = 1
...
if (global.currentroom == room_fire_core_left)
    dogcheck = 1
if (global.currentroom == room_fire_core_mettmeetingplace)
    dogcheck = 1
...
if (global.currentroom == room_castle_hook)
    dogcheck = 1
if (global.currentroom == room_water_bhouse_stairs)
    dogcheck = 1
...
if (global.currentroom == room_fire_core_warrior)
    dogcheck = 1
if (global.currentroom == room_tundra_qcshop_room)
    dogcheck = 1
...
if (global.currentroom == room_truelab_power)
    dogcheck = 1
if (global.currentroom == ROOM_HIM)
    dogcheck = 1
...
if (global.currentroom == room_f_room)
    dogcheck = 1
if (global.currentroom == ROOM_DOOR)
    dogcheck = 1
if (global.currentroom == ROOM_MAN)
    dogcheck = 1
if (global.currentroom == room_soundtest)
    dogcheck = 1
if (global.currentroom == TESTROOM)
    dogcheck = 1
if (global.currentroom == ROOM_MONITOR)
    dogcheck = 1
...
if (global.currentroom == room_flowey_endchoice)
    dogcheck = 1
if (global.currentroom == room_water_bhouse_cragview)
    dogcheck = 1
