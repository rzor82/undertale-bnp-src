...
if (con == 3 && instance_exists(OBJ_WRITER) == 0)
{
    ...
    if (quickskip == 0)
    {
        ff1 = instance_create(140, 290, obj_kitchenforcefield)
        ff1.image_xscale = 1
        ff1.image_yscale = 3
        ff2 = instance_create(560, 290, obj_kitchenforcefield)
        ff2.image_xscale = 1
        ff2.image_yscale = 3
        ff3 = instance_create(330, 200, obj_kitchenforcefield)
        ff3.image_xscale = 3
        ff3.image_yscale = 1
        ff4 = instance_create(410, 400, obj_kitchenforcefield)
        ff4.image_xscale = 3
        ff4.image_yscale = 1
        ff5 = instance_create(720, 290, obj_kitchenforcefield)
        ff5.image_xscale = 1
        ff5.image_yscale = 3
        alarm[4] = 60
    }
...
if (con == 5)
{
    if (global.flag[372] == 1 && serious_setup)
    {
...
if (con == 6 && instance_exists(OBJ_WRITER) == 0)
{
    ...
    global.faceemotion = 0
    global.msc = 0
    scr_anyface_dialogue(0, 0, "E", "M", -40, 24)
    global.msg[1] = scr_gettext("obj_mettnewsevent_174")
    global.msg[2] = scr_gettext("obj_mettnewsevent_175")
    global.msg[3] = scr_gettext("obj_mettnewsevent_176")
    global.msg[4] = scr_gettext("obj_mettnewsevent_177")
    global.msg[5] = scr_gettext("obj_mettnewsevent_178")
    global.msg[6] = scr_gettext("obj_mettnewsevent_179")
    global.msg[7] = scr_gettext("obj_mettnewsevent_180")
...
if (con == 65)
{
    ...
    global.msg[4] = "* NITROGLYCERIN.../"
    global.msg[5] = scr_gettext("obj_mettnewsevent_287")
    global.msg[6] = scr_gettext("obj_mettnewsevent_288")
    global.msg[7] = scr_gettext("obj_mettnewsevent_289")
    global.msg[8] = scr_gettext("obj_mettnewsevent_290")
    global.msg[9] = scr_gettext("obj_mettnewsevent_291")
    gr = instance_create(0, 0, obj_dialoguer)
    gr.side = 0
    con = 66
}
...
if (con == 172 && instance_exists(OBJ_WRITER) == 0)
{
    flowey = instance_create(40, 300, obj_stalkerflowey)
    obj_mainchara.cutscene = false
    __view_set(9, 0, 1584)
    with (obj_bounceright)
        special_spin = (scr_murderlv() < 2 && global.flag[221] == 0)
