...
if (con == 10 || con == 11)
{
    ...
    if (shaked > 0)
    {
        if (shaked < 1)
            shaked = 1
        __view_set(0, 0, (random(shaked) - random(shaked)))
        __view_set(1, 0, (random(shaked) - random(shaked)))
    }
}
if (powered == 1)
{
...
if (con == 38.2 && instance_exists(OBJ_WRITER) == 0)
{
    con = 38.3
    alarm[4] = 60
}
...
if (con == 50.2 && instance_exists(OBJ_WRITER) == 0)
{
    con = 50.3
    alarm[4] = 40
}
