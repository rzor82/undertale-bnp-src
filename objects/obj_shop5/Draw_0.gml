...
if (menu == 1 || menu == 2)
{
    var adiff = (20 - global.adef)
    if (menuc[1] == 0)
        scr_shop_draw_infobox(minimenuy, scr_gettext("shop5_itemdesc_22a"), "none", "none")
    if (menuc[1] == 1)
        scr_shop_draw_infobox(minimenuy, scr_gettext("shop5_itemdesc_22b"), "none", "none")
    if (menuc[1] == 2)
        scr_shop_draw_infobox(minimenuy, scr_gettext("shop5_itemdesc_22c"), "none", "none")
    if (murder == 0)
    {
        if (global.flag[276] == 0)
        {
            if (menuc[1] == 3)
                scr_shop_draw_infobox(minimenuy, scr_gettext("shop5_itemdesc_college"), "none", "none")
        }
        else if (menuc[1] == 3)
            scr_shop_draw_infobox(minimenuy, scr_gettext("shop5_itemdesc_64"), "none", adiff)
    }
    else if (menuc[1] == 3)
        scr_shop_draw_infobox(minimenuy, scr_gettext("shop5_itemdesc_22d"), "none", "none")
    else if (menuc[1] == 4)
...
if (menu == 5)
{
    ...
    if (keyboard_check_pressed(global.keybind[2]) && odd == 0)
    {
        if (value[(sellpos + 1)] != 0)
            sellpos += 1
    }
    if (keyboard_check_pressed(global.keybind[0]) && odd == 1)
        sellpos -= 1
