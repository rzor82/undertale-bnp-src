...
if (con == 1)
{
    ...
    tor = instance_create(640, 106, obj_torielbody)
    tor.hspeed = -10
    con = 2
}
if (con == 2)
...
{
    con = 6
    asg = instance_create(-340, 67, obj_sadgore)
    asg.hspeed = 8
    tor.hspeed = 8
}
if (con == 6)
...
if (con == 94)
{
    ...
    if (!instance_exists(obj_heart))
        instance_create(320, 300, obj_heart)
    border_d = 1
    tx = 320
    ty = 300
    con = 94.1
