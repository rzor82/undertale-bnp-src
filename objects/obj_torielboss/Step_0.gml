...
if (control_check_pressed(0) && destroyed == 0)
{
    if (conversation < 13)
    {
...
if (global.hurtanim[myself] == 2 && destroyed == 0)
{
...
if (global.hurtanim[myself] == 5 && destroyed == 0)
{
    global.damage = 0
...
if (global.mnfight == 2)
{
    if (attacked == 0)
    {
        ...
        if (global.hp > 2 && conversation < 13)
        {
            ...
            {
                speedrunruiner = irandom(6)
                switch speedrunruiner
                {
                    case 1:
                        global.turntimer = 160
                        global.firingrate = 4
                    ...
                    case 6:
                        global.border = 30
                        global.turntimer = 160
                        gen = instance_create(0, 0, obj_sinefiregen_tor)
                        if (global.hp > 6)
                            gen.dmg = 6
                        break
                    default:
                        global.turntimer = 190
                        gen = instance_create(0, 0, obj_torcfiregen)
                        if (global.hp > 6)
                            gen.dmg = 6
                        break
                }
...
if (conversation == 99 && instance_exists(OBJ_WRITER) == 0 && destroyed == 0)
{
    if instance_exists(OBJ_NOMSCWRITER)
    {
        with (blconwd)
