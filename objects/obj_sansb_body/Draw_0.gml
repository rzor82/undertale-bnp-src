...
if (bounce == 3 && movearm == 0)
{
    siner += 1
    yoff = (sin((siner / 18)) * 2)
}
else if (bounce == 2 && movearm == 0)
{
    siner += 1
    yoff = (sin((siner / 15)) * 4)
}
else if (bounce == 1 && movearm == 0)
{
    siner += 1
    yoff = sin((siner / 3))
    xoff = cos((siner / 6))
...
if (deadtest == 0)
{
    if (movearm == 0)
    {
        draw_sprite_ext(spr_sansb_legs, 0, x, (y + 96), 2, 2, 0, c_white, 1)
        draw_sprite_ext(spr_sansb_torso, global.flag[20], ((x + xoff) - 2), ((y + 42) + (yoff / 1.5)), 2, 2, 0, c_white, 1)
    }
    if (movearm == 1)
    {
        if (arm_i >= 11)
            arm_i = 11
        draw_sprite_ext(spr_sansb_rightstrike, floor((arm_i / 2)), x, (y + 48), 2, 2, 0, c_white, 1)
        if (arm_i == 2)
            headx = -4
        if (arm_i == 4)
            headx = -8
    ...
    if (movearm == 2)
    {
        if (arm_i >= 11)
            arm_i = 11
        draw_sprite_ext(spr_sansb_handup, floor((arm_i / 2)), x, (y + 48), 2, 2, 0, c_white, 1)
        if (arm_i == 0)
            heady = 4
        if (arm_i == 2)
            heady = 10
    ...
    if (movearm == 3)
    {
        if (arm_i >= 9)
            arm_i = 9
        draw_sprite_ext(spr_sansb_handdown, floor((arm_i / 2)), x, (y + 48), 2, 2, 0, c_white, 1)
        if (arm_i == 0)
            heady = 0
        if (arm_i == 2)
            heady = 0
    ...
    if (movearm == 4)
    {
        if (arm_i >= 10)
            arm_i = 10
        draw_sprite_ext(spr_sansb_rightstrike, floor((5 - (arm_i / 2))), x, (y + 48), 2, 2, 0, c_white, 1)
        if (arm_i >= 10)
            headx = 0
        if (arm_i == 8)
            headx = -4
    ...
    if (facetype == 1)
    {
        ...
        draw_sprite_ext(spr_sansb_face, 4, ((x + xoff) + headx), ((y + yoff) + heady), 2, 2, 0, c_white, 1)
}
if (deadtest == 1)
{
...
if (repeater == 1)
{
    ...
    rp_x += 0.05
    x -= floor((30 + rp_x))
    if (x < (__view_get(0, 0) - obj_sansb.sprite_width))
    {
...
if (death_c == 31)
{
    ...
    dsp = (sin((d_sin / 10)) * 1)
    hspeed = (-1 - dsp)
    if (x < (instance_exists(obj_expander) ? (-obj_expander.diffx) : -180))
        death_c = 32
}
if (death_c == 32)
{
...
if (global.debug == true)
{
    ...
    draw_text(0, 0, string_hash_to_newline(a_type))
}
