...
if (type == 0)
{
    ...
    if (oo == 1)
        draw_sprite_ext(spr_toriel_wrapshock, 0, (x + 2), (y + 6), 2, 2, 0, c_white, ii)
    draw_sprite_ext(spr_toriel_wrap, 0, (x + 24), (y + 14), 2, 2, 0, image_blend, image_alpha)
    if (shock == 1)
...
if (type == 1)
{
    ...
    if (ss < 0)
        image_blend = make_color_rgb(255, (255 + ss), (255 + ss))
    if (oo == 1)
        draw_sprite_ext(spr_pap_wrapshock, 0, (x - 6), (y + 4), 2, 2, 0, c_white, ii)
    draw_sprite_ext(spr_papwrap, 0, (x + 6), (y + 4), 2, 2, 0, image_blend, image_alpha)
    if (shock == 1)
        draw_sprite_ext(spr_papface_fatal, 0, (x + 40), y, 2, 2, 0, image_blend, image_alpha)
    else
    {
        if (face == 0)
            draw_sprite_ext(spr_papface_wrap, 0, (x + 34), y, 2, 2, 0, image_blend, image_alpha)
        if (face == 1)
            draw_sprite_ext(spr_paphead_believe, 0, (x + 34), y, 2, 2, 0, image_blend, image_alpha)
        if (face == 2)
            draw_sprite_ext(spr_asgore_shockface, 0, (x + 34), y, 2, 2, 0, image_blend, image_alpha)
    }
}
if (type == 2)
{
    ...
    draw_sprite_ext(spr_sanswrap, 0, (x - 6), (y + 2), 2, 2, 0, image_blend, image_alpha)
    if (shock == 1)
...
if (type == 3)
{
    ...
    if (oo == 1)
        draw_sprite_ext(spr_undynewrapshock, 0, (x + 2), (y + 12), 2, 2, 0, c_white, ii)
    draw_sprite_ext(spr_undynewrap, floor((siner / 5)), (x + 2), (y + 6), 2, 2, 0, image_blend, image_alpha)
    if (shock == 1)
...
if (type == 4)
{
    ...
    draw_sprite_ext(spr_alphyswrap, 0, (x + 8), y, 2, 2, 0, image_blend, image_alpha)
    if (shock == 1)
