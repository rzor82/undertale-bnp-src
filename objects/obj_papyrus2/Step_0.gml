...
if (conversation == 4.1 && instance_exists(OBJ_WRITER) == 0)
{
    ...
    global.msg[0] = scr_gettext("obj_papyrus2_264")
    mydialoguer = instance_create(0, 0, obj_dialoguer)
    conversation = 4.2
}
if (conversation == 4.2 && instance_exists(OBJ_WRITER) == 0)
{
    ...
    global.interact = 1
    papyrus.sprite_index = papyrus.ltsprite
    global.msg[0] = scr_gettext("obj_papyrus2_265")
    global.msg[1] = scr_gettext("obj_papyrus2_266")
    global.msg[2] = scr_gettext("obj_papyrus2_267")
    global.msg[3] = scr_gettext("obj_papyrus2_268")
    global.msg[4] = scr_gettext("obj_papyrus2_269")
    global.msg[5] = scr_gettext("obj_papyrus2_270")
    global.msg[6] = scr_gettext("obj_papyrus2_271")
    global.msg[7] = scr_gettext("obj_papyrus2_272")
    global.msg[8] = scr_gettext("obj_papyrus2_273")
    mydialoguer = instance_create(0, 0, obj_dialoguer)
    conversation = 6
}
...
if (conversation == 9)
{
    ...
    caster_set_pitch(global.currentsong, (0.6 + (0.4 * (alarm[1] / 30))))
}
if (conversation == 10)
{
...
if (conversation > 14 && audio_sound_get_pitch(global.currentsong) < 1)
    caster_set_pitch(global.currentsong, (audio_sound_get_pitch(global.currentsong) + 0.0133333333333333))
...
if (conversation == 21)
{
    if (hptalk == 1)
    {
        ...
        global.typer = 19
        global.msc = 0
        global.msg[0] = "YOU LOOK LIKE&YOU'RE HAVING FUN./%%"
        instance_create(0, 0, obj_dialoguer)
        hptalk = 2
    }
    else if (hptalk == 2 && (!instance_exists(obj_dialoguer)))
    {
        global.interact = 0
        hptalk = 3
    }
...
if (conversation == 22.1 && instance_exists(OBJ_WRITER) == 0)
{
    global.interact = 1
    global.msc = 0
    papyrus.fun = true
    papyrus.sprite_index = spr_papyrus_shakehead
    papyrus.image_speed = 0.17
    global.msg[0] = scr_gettext("obj_papyrus2_453")
    mydialoguer = instance_create(0, 0, obj_dialoguer)
    conversation = 22.2
}
if (conversation == 22.2 && instance_exists(OBJ_WRITER) == 0)
{
    ...
    papyrus.fun = false
    papyrus.sprite_index = papyrus.dtsprite
    global.msg[0] = scr_gettext("obj_papyrus2_454")
    global.msg[1] = scr_gettext("obj_papyrus2_455")
    global.msg[2] = scr_gettext("obj_papyrus2_456")
    global.msg[3] = scr_gettext("obj_papyrus2_457")
    global.msg[4] = scr_gettext("obj_papyrus2_458")
    mydialoguer = instance_create(0, 0, obj_dialoguer)
    conversation = 22.3
}
if (conversation == 22.3 && instance_exists(OBJ_WRITER) == 0)
{
    global.msc = 0
    papyrus.sprite_index = spr_papyrus_littlebuddy
    global.msg[0] = scr_gettext("obj_papyrus2_459")
    mydialoguer = instance_create(0, 0, obj_dialoguer)
    conversation = 23
}
if (conversation == 23)
...
if (conversation == 50)
{
    mc = scr_marker(obj_mainchara.x, obj_mainchara.y, spr_maincharar_geno)
    with (obj_mainchara)
        visible = false
    with (mc)
        scr_depth()
