if (laugh == 0)
{
    if (!drawface)
    {
        ...
        draw_sprite_ext(spr_floweystem, image_index, x, y, 2, 2, 0, c_white, image_alpha)
    if (drawface == 1)
        draw_sprite_ext(spr_floweyface_end, global.faceemotion, x, y, 2, 2, 0, c_white, image_alpha)
    if (con == 0 && image_index >= 10)
    {
        image_speed = 0
        drawface = 1
    }
...
{
    li += 1
    draw_sprite_ext(spr_floweylaugh, 2, x, y, 2, 2, 0, c_white, image_alpha)
}
