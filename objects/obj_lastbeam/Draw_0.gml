...
if (timer > beamtime)
{
    ...
    if (bw > 0)
    {
        ...
        if (home == 0)
        {
            draw_triangle_color(x, y, (mul * ((x + bw) + ob)), (window_get_height() + 10), (mul * ((x - bw) - ob)), (window_get_height() + 10), col, col2, col2, 0)
            draw_triangle_color(x, y, (mul * ((x + bw) + (ob / 2))), (window_get_height() + 10), (mul * ((x - bw) - (ob / 2))), (window_get_height() + 10), col, col2, col2, 0)
            draw_triangle_color(x, y, (mul * ((x + bw) - ob)), (window_get_height() + 10), (mul * ((x - bw) + ob)), (window_get_height() + 10), col, col3, col3, 0)
