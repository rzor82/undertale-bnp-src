if (con == 1)
{
    ...
    mkid = instance_create((__view_get(0, 0) - 40), obj_mainchara.y, obj_sans_actor)
    mkid.image_speed = 0
...
if (con == 28 && instance_exists(OBJ_WRITER) == 0)
{
    ...
    undyne.fun = true
    undyne.sprite_index = spr_undynea_r
    mkid.sprite_index = spr_mkid_u
    undyne.hspeed = 2
...
if (con == 119 && instance_exists(OBJ_WRITER) == 0)
{
    obj_mainchara.cutscene = false
    global.plot = 120
    global.flag[98] = 1
