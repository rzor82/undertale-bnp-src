    ...
    if (con == 90)
    {
        if instance_exists(OBJ_WRITER)
        {
            with (obj_speedrun_tracker)
                muffet_skip = obj_mainchara.x > ((other.x + 90) + other.sprite_width)
        }
        else
        {
            global.interact = 0
...
if (con == 17)
{
    ...
    if (murder == 1)
    {
        ...
        global.msg[2] = "* ...and they aren't&  even fit to&  be eaten~!/"
        global.msg[3] = scr_gettext("obj_spidertalkevent_295")
        con = 18
    }
