...
if (con == 50 && obj_mainchara.x > 490 && global.interact == 0)
{
    global.interact = 1
    global.msc = 0
    global.typer = 60
    ...
    {
        asg.hspeed = 5
        global.msg[0] = "* Eager to get this&  done and over with^1,&  are you?/"
        global.msg[1] = "* I understand^1.&\\E3* I do not want to.../"
        global.msg[2] = "* .../"
        global.msg[3] = "\\E2* I do not want to&  lay stress on this&  anymore either./%%"
    }
    instance_create(0, 0, obj_dialoguer)
    con = 51
}
