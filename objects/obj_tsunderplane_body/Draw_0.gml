...
{
    if (instance_exists(obj_tsunderplane) && obj_tsunderplane.altchance == 1)
    {
...
if (fall < 3)
{
    ...
    {
        if (shiny == 1)
            draw_sprite_ext(spr_tsunderplanehat_shiny, image_index, (154 + x), ((90 + y) + (sin((siner / 7)) * 3)), 2, 2, rot, c_white, alpha)
        else
...
if (fall == 3)
{
    ...
    if (room != room_end_castroll && shiny)
        draw_sprite_ext(spr_tsunderplanehat_shiny, image_index, (160 + x), ((90 + y) + (sin((siner / 7)) * 3)), 2, 2, rot, c_white, alpha)
    else
...
if (room != room_end_castroll)
{
    if (fall == 0 && instance_exists(parent))
    {
        ...
        {
            otherpl = instance_create(((x + 60) + random(60)), ((y + 60) + random(60)), obj_planeexhaust)
