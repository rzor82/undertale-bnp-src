...
if (con == 5)
{
    ...
    con = 6
    if (global.flag[411] > 0 && global.flag[410] == 0 && scr_murderlv() > 7)
    {
        global.facechoice = 3
        global.faceemotion = 3
        global.typer = 17
        global.msg[0] = "* hey^1,\\E0 uh.../"
        global.msg[1] = "\\E1* normally^1, i'm supposed&  to say some sorta&  speech^1, but.../"
        global.msg[2] = "\\E3* dude^1.&\\E0* you killed^1, like^1,&\\E1  so many people./"
        global.msg[3] = "\\E6* your pockets must be&  heavy from all the&  money you stole./"
        global.msg[4] = "\\E3* but what annoys me&  the most.../"
        global.msg[5] = "\\E0* is that you didn't even&  go all out?/"
        global.msg[6] = "* you spared all of the&  vulkins^1.&\\E1* only the vulkins./"
        global.msg[7] = "\\E5* wow^1,\\E1 you really suck^1,&  huh?&* you're a messed up kid./"
        global.msg[8] = "\\E4* you can't even be evil&  right^1, get outta here./%%"
        con = 7
    }
...
if (con == 100)
{
    ...
    mc = scr_marker(obj_mainchara.x, obj_mainchara.y, spr_maincharar_shadow_geno)
    mc.depth = obj_mainchara.depth
    mc.image_blend = c_white
    global.msc = 0
    global.facechoice = 3
    global.faceemotion = 0
    global.typer = 17
    ...
    if (sansf == 10)
    {
        ...
        global.msg[6] = "\\E1* oh yeah./"
        global.msg[7] = scr_gettext("obj_lastsans_trigger_729")
        con = 111
    }
    if (sansf == 11)
    {
    ...
    if ((sansf >= 12 && sansf < 100) || sansf >= 101)
    {
    ...
    if (sansf == 100)
    {
        ...
        global.msg[1] = "\\E1* that's the expression&  of someone who's died&  a hundred times in a row!/"
        global.msg[2] = "\\E3* yup^1, that look's&  unmistakable./"
        global.msg[3] = "\\E2* wow^1, that's gotta be&  a new world&  record.../"
        global.msg[4] = "\\E1* ...well^1, a world record&  for being really^1, REALLY&  bad./"
        global.msg[5] = "\\E0* and^1, you're looking a&  bit tired there./"
        global.msg[6] = "\\E2* why not take a break&  and come back tomorrow?/"
        global.msg[7] = "\\E3* maybe then^1,&  you'll finally beat me./"
        global.msg[8] = "\\E0* bu^1t uh..^1.&\\E1* looking at your&  performance so far.../"
        global.msg[9] = "\\E4* somehow i doubt that./%%"
        con = 111
    }
    if (sansk > 0)
    {
