...
{
    if (obj_astigmatism.altchance == 7)
    {
        draw_sprite_ext(spr_astigmatism_handl_shiny, (anim2 / 3), ((x + 8) + ((sin((siner / 6)) * 2) * sfactor)), ((y + 64) + ((cos((siner / 6)) * 2) * sfactor)), 2, (1.8 + ((cos((siner / 6)) * 0.2) * sfactor)), 0, c_white, 1)
        draw_sprite_ext(spr_astigmatism_legl_shiny, (anim2 / 3), ((x + 30) + ((cos((siner / 6)) * 2) * sfactor)), ((y + 84) + ((sin((siner / 6)) * 2) * sfactor)), 2, (1.8 + ((sin((siner / 6)) * 0.2) * sfactor)), 0, c_white, 1)
        draw_sprite_ext(spr_astigmatism_handl_shiny, (anim2 / 3), ((x + 92) - ((sin((siner / 6)) * 2) * sfactor)), ((y + 64) - ((cos((siner / 6)) * 2) * sfactor)), -2, (1.9 - ((cos((siner / 6)) * 0.2) * sfactor)), 0, c_white, 1)
        draw_sprite_ext(spr_astigmatism_legl_shiny, (anim2 / 3), ((x + 70) - ((cos((siner / 6)) * 2) * sfactor)), ((y + 84) - ((sin((siner / 6)) * 2) * sfactor)), -2, (1.8 - ((sin((siner / 6)) * 0.2) * sfactor)), 0, c_white, 1)
        draw_sprite_ext(spr_astigmatism_anim2_shiny, (anim2 / 3), x, y, 2, 2, 0, c_white, 1)
    }
    else
    {
