...
s_f2 = sin((siner / 3))
s_f3 = sin((siner / 14))
draw_sprite_ext(spr_undynex_hair, 0, (x + 82), (((y + (s_f * 3)) + heady) - 2), 2, 2, (70 - (s_f * 15)), c_white, 1)
draw_sprite_ext(spr_undynex_legs, 0, (x + 100), (y + 160), 2, 2, 0, c_white, 1)
if (arm_v == 0)
...
draw_sprite_ext(spr_undynex_pants, 0, (x + 100), ((y + 126) + (s_f * 2)), 2, 2, (s_f * 2), c_white, 1)
if (facetype == 0)
{
    if (pause == 0)
        draw_sprite_ext(spr_undynex_face1, floor((siner / 3)), (x + 102), (((y + 28) + (s_f * 2)) + heady), 2, 2, 0, c_white, 1)
    if (pause == 1)
        draw_sprite_ext(spr_undynex_face_damage, floor((siner / 3)), (x + 102), (((y + 28) + (s_f * 2)) + heady), 2, 2, 0, c_white, 1)
}
if (facetype == 1)
    draw_sprite_ext(spr_undynex_face_laugh, floor((siner / 3)), (x + 102), (((y + 28) + (s_f * 2)) + heady), 2, 2, 0, c_white, 1)
if (facetype == 2)
    draw_sprite_ext(spr_undynex_face_e, global.faceemotion, (x + 102), (((y + 28) + (s_f * 2)) + heady), 2, 2, 0, c_white, 1)
draw_sprite_ext(spr_undynex_fancyhair, global.faceemotion, (x + 72), (((y - 16) + (s_f * 2)) + heady), 2, 2, 0, c_white, 1)
if (facetype != 0)
    eyetimer = 0
eyetimer += 1
if (eyetimer >= 10)
