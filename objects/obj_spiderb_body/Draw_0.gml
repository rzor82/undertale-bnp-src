...
draw_sprite_ext(spr_spiderb_upperarm_alt, 0, (x + 78), (((y + 86) + 26) + cos((siner / 5))), 2, 2, (sin((siner / 5)) * 6), c_white, 1)
...
if (mode == 0)
{
    draw_sprite_ext(spr_spiderb_teapot_alt, 0, (x - 22), ((y + 104) + (cos((siner / 5)) * 2)), 2, 2, ((-(sin((siner / 5)))) * 24), c_white, 1)
