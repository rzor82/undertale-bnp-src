...
if (burston == 1)
{
    draw_sprite_ext(spr_mneo_burst, 0, (x - 18), ((y + 16) + (sin((siner / 3)) * 1)), -2, 2, (sin((siner / 6)) * 2), c_white, ((abs(sin((siner * 0.3))) * 0.5) + 0.4))
    draw_sprite_ext(spr_mneo_burst, 0, (x + 24), ((y + 16) + (sin((siner / 3)) * 1)), 2, 2, ((-(sin((siner / 6)))) * 2), c_white, ((abs(sin((siner * 0.3))) * 0.5) + 0.4))
}
