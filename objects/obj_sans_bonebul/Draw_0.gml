...
if (type == 0 || type == 1)
{
    ...
    if (width > 0)
    {
        ...
        draw_sprite_part_ext(spr_s_bonebul_top, 0, le, 0, width, 6, (x + le), y, 1, 1, draw_get_color(), 1)
        ...
        draw_sprite_part_ext(spr_s_bonebul_bottom, 0, le, 0, width, 6, (x + le), (global.idealborder[3] - 6), 1, 1, draw_get_color(), 1)
    }
}
if (type == 2)
{
...
if (x < __view_get(0, 0) && hspeed < 0)
    instance_destroy()
if (x > window_get_width() && hspeed > 0)
    instance_destroy()
