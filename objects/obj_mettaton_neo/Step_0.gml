...
if (mercymod == 222 && instance_exists(OBJ_WRITER) == 0)
    script_execute(scr_mercystandard)
if (global.mnfight == 0 && global.myfight == 0 && (obj_time.time % 30) == 0 && random(1) < 0.4)
    global.ratings = (1 + irandom_range(0, 3))
if (con == 21)
{
    mypart1.hspeed = -3
    con = 22
...
if (con == 23)
{
    ...
    global.typer = 97
    global.msc = 0
    if (scr_murderlv() < 15 || global.flag[397] == 0)
    {
...
if (con == 26)
{
    ...
    if (scr_murderlv() >= 15 && global.flag[397] == 1)
    {
        if (global.xp <= 50000)
            global.xp = 50000
    }
