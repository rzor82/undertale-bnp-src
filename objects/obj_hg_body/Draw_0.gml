...
if (con == 3)
{
    ...
    if instance_exists(obj_roundedge)
    ...
    {
        limx = (-obj_expander.diffx)
        limy = (-obj_expander.diffy)
    }
    for (i = 0; i < 5; i += 1)
        draw_line_width_color((((room_width / 2) + random(10)) - random(10)), (((room_height / 2) + random(10)) - random(10)), random(window_get_width()), window_get_height(), 2, c_white, c_gray)
    for (i = 0; i < 5; i += 1)
        draw_line_width_color((((room_width / 2) + random(10)) - random(10)), (((room_height / 2) + random(10)) - random(10)), random(window_get_width()), limy, 2, c_white, c_gray)
    for (i = 0; i < 5; i += 1)
        draw_line_width_color((((room_width / 2) + random(10)) - random(10)), (((room_height / 2) + random(10)) - random(10)), limx, random(window_get_height()), 2, c_white, c_gray)
    for (i = 0; i < 5; i += 1)
        draw_line_width_color((((room_width / 2) + random(10)) - random(10)), (((room_height / 2) + random(10)) - random(10)), window_get_width(), random(window_get_height()), 2, c_white, c_gray)
    draw_set_alpha(1)
