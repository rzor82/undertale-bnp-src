...
if (global.mnfight == 2)
{
    if (attacked == 0)
    {
        ...
        if (mycommand >= 25)
        {
            ...
            gench = choose(0, 1)
            if (gench == 0)
                gen = instance_create((global.idealborder[1] - 50), (global.idealborder[3] - 45), blt_orangespear)
            else
    ...
    if (whatiheard != -1)
    {
        if (global.heard == 0)
        {
            ...
            if (whatiheard == 2)
            {
                ...
                {
                    global.msc = 0
                    global.msg[0] = "* You go on a short&  walk with Doge./^"
                    with (OBJ_WRITER)
                        halt = 3
                    iii = instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER)
                    with (iii)
            ...
            if (whatiheard == 5)
            {
                ...
                {
                    global.msc = 0
                    global.msg[0] = "* You pet Doge.&* What a good Doge./^"
                    with (OBJ_WRITER)
                        halt = 3
                    iii = instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER)
                    with (iii)
