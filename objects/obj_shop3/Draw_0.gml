caster_set_volume(snd_hotel_alarm, 0.4)
if (menu == 1 || menu == 2)
{
    ...
    {
        if soldout
            scr_shop_draw_infobox(minimenuy, scr_gettext("shop3_itemdesc_soldout"), "none", "none")
        else
            scr_shop_draw_infobox(minimenuy, scr_gettext(("shop3_itemdesc_" + string(item[menuc[1]]))), wdiff, adiff)
    }
    else if (menuc[1] == 4)
        scr_shop_draw_infobox(minimenuy, " ", "none", "none")
}
if (menu == 0)
    scr_shop_draw_window(menu < 4, 1)
else if (menu == 4)
    scr_shop_draw_window(menu < 4, 2)
else if (menu == 1 || menu == 2)
    scr_shop_draw_window(menu < 4, 3)
else if (menu == 3)
    scr_shop_draw_window(menu < 4, 4)
