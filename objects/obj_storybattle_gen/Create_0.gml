...
if (scr_murderlv() < 16)
{
    ...
    {
        con = 50
        m1 = instance_create(50, 20, obj_chilldrake)
        m2 = instance_create(450, 20, obj_chilldrake)
    }
    ...
    if (global.flag[450] == 8)
    {
        ...
        m2 = instance_create(270, 140, obj_tembody)
    ...
    if (global.flag[450] == 9)
    {
        ...
        m2 = instance_create(270, 130, obj_aaron)
        m3 = instance_create(470, 240, obj_moldsmalx_body)
    }
    ...
    {
        con = 150
        global.monsterinstance[0] = instance_create(10, 10, obj_pyrope)
        global.monsterinstance[1] = instance_create(430, 120, obj_vulkin)
        global.monsterinstance[2] = instance_create(120, 100, obj_tsunderplane)
    }
