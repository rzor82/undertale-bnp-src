...
if (sprite_index == spr_torielboss_kneel)
    draw_sprite_ext(spr_torweird, global.faceemotion, (x + 34), (y + 50), 2, 2, 0, c_white, 1)
if (sprite_index == spr_torielside1 || sprite_index == spr_torielboss_side)
    draw_sprite_ext(spr_torweird, global.faceemotion, (x + 34), y, 2, 2, 0, c_white, 1)
if (con == 0)
{
...
if (draw_u > 0)
{
    ...
    if (draw_u >= 6)
    {
        ...
        draw_text_transformed(320, yy, string_hash_to_newline("Press the [x] button, stupid!"), 0.5, 0.5, 0)
        draw_set_alpha(1)
    }
...
if (draw_f == 2)
{
    draw_sprite_ext(spr_floweystem, 8, fx, fy, 2, 2, 0, c_white, 1)
...
if (con == 54 && control_check_pressed(1))
    con = 55
if (con == 55)
{
    draw_set_alpha(blk)
