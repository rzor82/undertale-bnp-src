if (conversation == 1 && instance_exists(obj_dialoguer) == 0)
{
    ...
    if (gdraw == 1)
    {
        obj_toroverworld3.rsprite = spr_toriel_handhold_geno_r
        obj_toroverworld3.usprite = spr_toriel_handhold_geno_u
        obj_toroverworld3.sprite_index = spr_toriel_handhold_geno_r
    }
...
if (conversation == 3 && instance_exists(obj_dialoguer) == 0)
{
    ...
    with (obj_toroverworld3)
        visible = false
    if (gdraw == 1)
        ruff = scr_marker(obj_toroverworld3.x, obj_toroverworld3.y, spr_toriel_ruffle_geno)
    else
