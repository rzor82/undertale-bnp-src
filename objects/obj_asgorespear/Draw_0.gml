...
if (armtest == 1)
{
    if instance_exists(obj_asgoreb_body)
    {
        ...
        if (armsize < 0.35)
            armsize = 0
        draw_sprite_ext(spr_asgoreb_ballarm2, 0, point1x, point1y, (armsize * 2), 2, armangle, c_white, 1)
...
if (keyboard_check(ord("3")) && debuggo == 1)
    color = 0x4039E0
if (keyboard_check(ord("4")) && debuggo == 1)
    color = 0x277FFF
if (keyboard_check(ord("5")) && debuggo == 1)
