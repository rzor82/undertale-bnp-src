...
if (global.hurtanim[myself] == 2)
{
    ...
    with (dmgwriter)
        alarm[2] = 15
    if (global.monsterhp[myself] <= (global.monstermaxhp[myself] / 4) && global.monsterhp[myself] >= 1)
    {
        mypart1 = instance_create(x, y, obj_froghead)
        mypart2 = instance_create(x, y, obj_froglegs)
        mypart1.path_speed = 0.3
        mypart1.image_speed = 0.03
        mypart2.image_speed = 0.04
        mypart1.sprite_index = spr_froghead_lowhp
        mypart2.sprite_index = spr_froglegs_lowhp
        if (other.altchance == 7)
        {
            mypart1.sprite_index = spr_froghead_lowhp_shiny
            mypart2.sprite_index = spr_froglegs_lowhp_shiny
        }
