if (con > 0)
{
    ...
    if (con == 18)
    {
        ...
        if (global.flag[38] == 1)
        {
            global.msg[2] = "\\E5* I u-uh..^1. noticed&  that you had one...&  already.../"
            global.msg[3] = scr_gettext("obj_alphystrigger2_223")
            global.msg[4] = scr_gettext("obj_alphystrigger2_224")
            global.msg[5] = scr_gettext("obj_alphystrigger2_225")
            global.msg[6] = scr_gettext("obj_alphystrigger2_226")
        }
