...
if (s_click == 1 && instance_exists(OBJ_WRITER))
{
    ...
    {
        if (sprite_index == spr_sans_d)
            sprite_index = spr_sans_ddangerous
        if (sprite_index == spr_sans_r)
            sprite_index = spr_sans_rdangerous
        if (sprite_index == spr_sans_l)
            sprite_index = spr_sans_ldangerous
        caster_free(-3)
    }
}
