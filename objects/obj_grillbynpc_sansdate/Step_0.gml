...
if (con == 17.1)
{
    if (y <= 75)
    {
        ...
        obj_mainchara.sprite_index = spr_mainchara_sanssit
...
if (con == 41.6 && instance_exists(OBJ_WRITER))
{
    if (OBJ_WRITER.stringno == 1)
    {
        if (squirt == 0)
            snd_play(snd_splat)
        squirt += 1
        obj_mainchara.sprite_index = spr_mainchara_sanssit_spillchup
        obj_mainchara.image_speed = 0
        food1.image_index = 1
        con = 42
    }
    ...
    {
        obj_mainchara.sprite_index = spr_mainchara_sanssit_pourchup
        obj_mainchara.image_speed = 0.2
    }
}
...
if (con == 63 && instance_exists(OBJ_WRITER) == 0)
{
    ...
    if (global.gold >= 10000)
    {
        ...
        global.msg[1] = "\\E3* i'm flattered you'd&  wanna spend&  it on this.../"
        global.msg[2] = "* but i'm&  just kidding&  with ya./"
        global.msg[3] = scr_gettext("obj_grillbynpc_sansdate_709")
    }
    con = 64
    instance_create(0, 0, obj_dialoguer)
}
...
if (con == 73)
{
    ...
    global.msg[0] = "\\W* (You feel like your&  connection to \\YSans\\W is&  growing deeper...)/%%"
    scr_regulartext()
    obj_mainchara.image_speed = 0
    obj_mainchara.vspeed = 0
    con = 74
