if (side == 0)
{
    ...
    if (con == 3)
    {
        repeat (4)
        {
            fire = instance_create(((global.idealborder[0] + random((len - 6))) - 6), 0, obj_torsided_fire)
            fire.dmg = dmg
        }
    }
    if (con == 4)
...
if (side == 1)
{
    ...
    if (con == 3)
    {
        repeat (4)
        {
            fire = instance_create(((global.idealborder[1] - random((len + 6))) - 8), 0, obj_torsided_fire)
            fire.dmg = dmg
        }
    }
    if (con == 4)
